...
def print_best(minimize_stage_key='san'):
    ...
    best_stages = [d for s,d in stages().items() if d.id in stageid_tran]
...
if __name__ == '__main__':
    # farmcalc.init(server='US',minimize_stage_key='',lang='zh',update=False)
    farmcalc.init(server='US',minimize_stage_key='',lang='en',update=False)
    print_best()
...
"MAIN"                                # 0-2['Drill Battle Record'] 1-7['Orirock Cube'] 2-3['Damaged Device'] S2-5['Orirock'] 2-10['RMA70-12'] 3-1['Aketon'] 3-3['Grindstone'] 3-4['Integrated Device'] 3-7['Polyketon'] 3-8['Polyester Pack'] 4-2['Sugar Pack'] 4-8['Grindstone'] 4-9['RMA70-12'] 5-7['Grindstone', 'Oriron'] 5-10['Integrated Device', 'Orirock Cube'] 7-12['Sugar Pack', 'Polyketon'] 7-15['Integrated Device'] 7-18['Oriron Cluster', 'Polyketon'] R8-2['Loxic Kohl'] R8-11['Crystalline Component'] 9-3['Device'] 9-16['Grindstone', 'Oriron'] 9-18['Semi-Synthetic Solvent'] 9-19['RMA70-12'] 10-3['Coagulating Gel'] 10-3['Coagulating Gel'] 10-4['Device', 'Aketon'] 10-6['Orirock Cluster'] 10-7['Manganese Ore'] 10-11['Oriron Cluster'] 10-16['Polyester', 'Manganese Ore'] 10-17['Compound Cutting Fluid'] 11-3['Transmuted Salt'] 11-3['Transmuted Salt'] 11-6['Sugar Pack', 'Oriron'] 11-7['Integrated Device'] 11-7['Integrated Device'] 11-8['Semi-Synthetic Solvent'] 11-13['Loxic Kohl'] 11-14['Incandescent Alloy'] 12-5['Coagulating Gel'] 12-9['Tactical Battle Record'] 12-10['Semi-Synthetic Solvent'] 12-12['Incandescent Alloy'] 12-17['Compound Cutting Fluid']
"SUB"                                 # S3-1['Sugar'] S3-2['Polyester'] S3-3['Oriron']
"DAILY"                               # CE-6[] SK-2['Carbon Stick'] SK-3['Carbon Stick', 'Carbon Brick'] SK-5['Carbon Brick', 'Carbon Brick'] LS-6['Tactical Battle Record', 'Strategic Battle Record'] CA-2['Skill Summary - 1'] CA-3['Skill Summary - 2', 'Skill Summary - 1'] CA-5['Skill Summary - 3', 'Skill Summary - 1', 'Skill Summary - 2'] PR-A-1['Defender Chip', 'Medic Chip'] PR-A-2['Defender Chip Pack', 'Medic Chip Pack'] PR-B-1['Sniper Chip', 'Caster Chip'] PR-B-2['Sniper Chip Pack', 'Caster Chip Pack'] PR-C-1['Vanguard Chip', 'Supporter Chip'] PR-C-2['Vanguard Chip Pack', 'Supporter Chip Pack'] PR-D-1['Guard Chip', 'Specialist Chip'] PR-D-2['Guard Chip Pack', 'Specialist Chip Pack']
