...
#
shops_raw={
('Onboard Services', 'act30side_token_box'):
                                                ...
                                                'Furniture Part 10 2',
                                                'LMD 20 1'],
('#1 pyrolysis', 'CRISIS_SHOP_COIN_V2','skip'):
                                                [
                                                # 'Headhunting Permit 1 150',
                                                'Bipolar Nanoflake 1 200',
                                                'Optimized Device 1 100',
                                                'White Horse Kohl 1 55',
                                                'RMA70-24 1 70',
                                                'Crystalline Circuit 1 80',
                                                'Refined Solvent 1 65',
                                                'Orirock Cluster 1 15',
                                                'Oriron Cluster 1 20',
                                                'Aketon 1 20',
                                                'Grindstone 1 20',
                                                'Compound Cutting Fluid 1 20',
                                                'LMD 6000 17',
                                                'Tactical Battle Record 6 17',
                                                'Orirock Cube 1 5',
                                                'Sugar 1 8',
                                                'Polyester 1 8',
                                                'Oriron 1 10',
...
('Dipartimento', 'act21side_token_permesso','skip'):
                                                ['Headhunting Permit 1 150',
                                                'Bipolar Nanoflake 1 100',
                                                'Crystalline Electronic Unit 1 100',
                                                'Refined Solvent 1 35',
